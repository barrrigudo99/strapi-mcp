...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-KTIIC7DJ.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-O4MEV5VI.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-O4MEV5VI.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-O4MEV5VI.js");
...
//# sourceMappingURL=chunk-N56A2JWT.js.map
