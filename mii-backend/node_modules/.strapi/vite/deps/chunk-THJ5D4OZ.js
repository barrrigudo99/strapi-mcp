...
import {
  ...
  HOOKS
} from "./chunk-B7TWEBTH.js";
import {
  useNpsSurveySettings
} from "./chunk-RQTPQE3I.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-DNPEP6WQ.js";
import {
  useGetAIUsageQuery
...
import {
  ...
  getEERoutes
} from "./chunk-VTTJ6QBO.js";
import {
  Login
} from "./chunk-YYKCFDZ4.js";
import {
  MemoizedInputRenderer
} from "./chunk-4RGFBE4V.js";
import {
  Form
} from "./chunk-EWZTBVJG.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-BGLT37T3.js";
import {
  ConfigurationProvider
} from "./chunk-P3UYOINP.js";
import {
  require_baseMerge,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-5UMHIQJG.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-FM4H7D3W.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-SRFJVNSZ.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-VHPYBH4M.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-QVDY7Z6R.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-ELD4CNFB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-4UV5UMYL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-TKKYJ54O.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-RNNADL5M.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-DKTCGXT6.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-KSEW4GCX.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4EM5745M.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-DANAM7TB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-DMYGYWDL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-MDARJ7HM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-KC4FSXWX.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-A5S4YG4Z.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-V2CVVDR3.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-PTAMCVKE.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-X45JVKRI.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-5IVUZUID.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-U62WZRK4.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-ZMMPZJW6.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-Z4UAIQGC.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-FY6EL7TH.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-VK6WKIZW.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-G5TTOT4M.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-G5TTOT4M.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-AHHLCAKL.js");
...
//# sourceMappingURL=chunk-THJ5D4OZ.js.map
